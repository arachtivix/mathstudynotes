...
(deftest matches-pattern-test-2
...
(deftest seq-from-try-deltas-test
  (testing "Testing seq-from-try-deltas"
    ...
    (is (= (take 5 (seq-from-try-deltas [1 [2 3]])) '(1 3 6 8 11)))
    (is (= (take 3 (seq-from-try-deltas [100 [1 2 1 4]])) '(100 101 103)))
    (is (= (take 5 (seq-from-try-deltas [nil []])) '()))))